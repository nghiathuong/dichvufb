...
if ($getUser['level'] == 4) { ?>
    <?php
    $title = "Quản lí dịch vụ CMT sale";
    $showDatabase = true;
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Quản lí lịch vụ bình luận sale</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Quản lí lịch vụ bình luận sale</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Quản lí lịch vụ bình luận sale</h3>
                                    ...
                                    <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="wd-25p border-bottom-0">Cmt</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $list_user = $DUONGSHADO->get_list("SELECT * FROM history_order WHERE code_server = 'cmt_sale'");
    ...
    <script>
        $(document).ready(function() {
            $('#btn_update').on('click', function(e) {
                ...
                Swal.fire({
                    title: 'Cảnh báo?',
                    text: "Hãy chú ý bạn hãy chọn ít nhất 1 id order để không bị lỗi!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: 'Tôi đã đọc!'
                }).then((result) => {
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?= BASE_URL("_admin/oders/xuly/cmt-sale") ?>',
                            type: 'POST',
                            data: {
                                order_id: order_id
                            },
