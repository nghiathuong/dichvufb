...
if ($getUser['level'] == 4) { ?>
    <?php
    $title = "Quản lí dịch vụ like post";
    $showDatabase = true;
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Quản lí lịch vụ like post sale</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Quản lí lịch vụ like post sale</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Quản lí lịch vụ like post sale</h3>
                            ...
                            <div class="card-body">
                                <div class="table-responsive text-center">
                                    <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            $list_user = $DUONGSHADO->get_list("SELECT * FROM history_order WHERE code_server = 'like_post_sale'");
