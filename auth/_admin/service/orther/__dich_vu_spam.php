        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Quản lí dịch vụ spam</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Quản lí dịch vụ spam</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Quản lí dịch vụ spam</h3>
                                <div class="mx-auto">
                                    <a class="modal-effect btn btn-success-light" data-bs-effect="effect-scale" data-bs-toggle="modal" href="#add_sv">Thêm dịch vụ</a>   
                                </div>
                                <div class="mx-auto">
                                    <a class="btn btn-primary-light" href="<?=BASE_URL('_admin/service/orther/add/dich-vu-spam/order')?>">Quản lí đơn hàng</a>   
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive text-center">
                                    <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            $list_user = $DUONGSHADO->get_list("SELECT * FROM service_server WHERE code_server = 'spam_cmt_phone' AND key_server = 'orther_service' ");
    ...
    <script>
        $(document).ready(function(){
            $('#btn_add').on('click', function(e){
                ...
                $.ajax({
                    url: "<?= BASE_URL('_admin/service/orther/add/dich-vu-spam') ?>",
                    type: "POST",
                    data: {
                        '_token': $('meta[name="csrf-token"]').attr('content'),
                        server: server,
