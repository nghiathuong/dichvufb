    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Sub/Follow Speed</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Facebook</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Sub/Follow Speed</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xl-8">
                    <div class="card cart">
                        <div class="card-header">
                            <h3 class="card-title">Tăng Sub/Follow Speed</h3>
                            <div class="card-title text-white justify-content-end mx-auto">
                                <a href="<?= BASE_URL('service/facebook/sub-speed/order') ?>" class="btn btn-success">Lịch sử mua</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="<?=BASE_URL('service/api/facebook/sub-speed')?>" method="POST"
                            request-ajax="LBD" call="swal" href="sub-speed">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    $server = $DUONGSHADO->get_list("SELECT * FROM service_server WHERE code_server ='sub_speed' AND status_server = 'active' AND key_server = 'facebook_service'  ");
                                ...
                                <div class="alert alert-danger bg-danger text-white">
                                    ...
                                    - Sv1 tốc độ lên ổn max 15k không bảo hành. <br />
                                    - Sv2 tốc độ lên ổn max 20k không bảo hành. <br />
                                    - Sv3 tốc độ lên ổn max 100k không bảo hành. <br />
                                    - Sv4 tốc độ lên nhanh max 10k không bảo hành. <br />
                                    - Sv5 tốc độ lên nhanh (ngày 100k -> 1 triệu sub, đơn lên sau 12h -> 24h, từ đơn thứ
                                    2 của 1 ID lên sau 12h -> 48h) max không
                                    giới hạn, bảo hành 7 ngày (gần như không tụt), không chạy cho pro5. <br />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button type="submit" confirm="Bạn có chắc chắn muốn mua đơn hàng này" class="btn btn-primary btn-block py-3" id="btn_payment"> <img src="<?= BASE_URL('assets/images/bank/payment.png') ?>" class="w-6" alt=""> Thanh toán</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered text-center" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Lấy id facebook</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
