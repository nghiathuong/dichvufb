    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Sub/Follow Quality</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Facebook</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Sub/Follow Quality</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xl-8">
                    <div class="card cart">
                        <div class="card-header">
                            <h3 class="card-title">Tăng Sub/Follow Quality</h3>
                            <div class="card-title text-white justify-content-end mx-auto">
                                <a href="<?= BASE_URL('service/facebook/sub-quality/order') ?>" class="btn btn-success">Lịch sử mua</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="<?=BASE_URL('service/api/facebook/sub-quality')?>" method="POST"
                            request-ajax="LBD" call="swal" href="sub-quality">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    $server = $DUONGSHADO->get_list("SELECT * FROM service_server WHERE code_server ='sub_quality' AND status_server = 'active' AND key_server = 'facebook_service'  ");
                                ...
                                <div class="alert alert-danger bg-danger text-white">
                                    ...
                                    - Mua bằng ID Facebook đã mở chế độ công khai, có nút theo dõi, mở nút kết bạn, khi
                                    có yêu cầu kết bạn không được đồng ý để k tụt sub.<br />
                                    - Sv1 tốc độ lên ổn định ngày 3k -> 5k, sub via nên gần như không tụt, loại sub này
                                    max 100k (bảo hành 3
                                    tháng). <br />
                                    - Sv2 tốc độ lên ổn định ngày 1k -> 5k, sub via nên gần như không tụt, loại sub này
                                    max 100k (bảo hành 3 tháng). <br />
                                    - Sv3 tốc độ lên ổn định ngày 1k -> 5k, sub via nên gần như không tụt, loại sub này
                                    max 1m sub không bảo hành. <br />
                                    - Sau khi mua sub sẽ lên sau 5s -> 1h. <br />
                                    - Nên buff dư cho khách tránh tụt nhé!.
                                </div>
                                <div class="form-group">
                                    <label for="" class="form-label">Số lượng</label>
                                    <input type="number" name="soluong" id="soluong" class="form-control" onkeyup="bill()" value="500">
                                </div>
                                <div class="form-group">
