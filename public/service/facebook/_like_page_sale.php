    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Sub/Follow page sale</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Facebook</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Sub/Follow page sale</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xl-8">
                    <div class="card cart">
                        <div class="card-header">
                            <h3 class="card-title">Tăng Sub/Follow page sale</h3>
                            <div class="card-title text-white justify-content-end mx-auto">
                                <a href="<?= BASE_URL('service/facebook/sub-page-sale/order') ?>" class="btn btn-success">Lịch sử mua</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="<?=BASE_URL('service/api/facebook/page-sale')?>" method="POST"
                            request-ajax="LBD" call="swal" href="like-page-sale">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    $server = $DUONGSHADO->get_list("SELECT * FROM service_server WHERE code_server ='like_page_sale' AND status_server = 'active' AND key_server = 'facebook_service'  ");
                                ...
                                <div class="alert alert-danger bg-danger text-white">
                                    ...
                                    - Mua bằng ID Page đã mở chế độ công khai, có nút like. <br />
                                    - Sv1 tốc độ 10k -> 30k/ngày, có bảo hành tự động trong 7 ngày. <br />
                                    - Sv2 tốc độ 5k -> 20k/ngày, có bảo hành tự động trong 7 ngày. <br />
                                    - Sv3 tốc ổn 2k -> 10k/ngày, có bảo hành tự động trong 7 ngày. <br />
                                    - Sv4 tốc độ 200 -> 3k/ 1 ngày, có bảo hành tự động trong 7 ngày. <br />
                                    - Sau khi mua like sẽ lên sau 10p -> 1h. <br />
