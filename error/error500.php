...
<!-- Mirrored from laravel8.spruko.com/sash/error500 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 17:07:09 GMT -->
...
<head>
                    ...
                    <div class="predefined_styles">
                        ...
                        <div class="swichermainleft">
                            ...
                            <div class="skin-body switch_section">
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <a class="bg-img1 bg-img" href="javascript:void(0);"><img src="assets/images/media/bg-img1.jpg"  alt="Bg-Image" id="bgimage1"></a>
                                    <a class="bg-img2 bg-img" href="javascript:void(0);"><img src="assets/images/media/bg-img2.jpg"  alt="Bg-Image"  id="bgimage2"></a>
                                    <a class="bg-img3 bg-img" href="javascript:void(0);"><img src="assets/images/media/bg-img3.jpg"  alt="Bg-Image" id="bgimage3"></a>
                                    <a class="bg-img4 bg-img" href="javascript:void(0);"><img src="assets/images/media/bg-img4.jpg"  alt="Bg-Image" id="bgimage4"></a>
                                </div>
                            </div>
                        </div>
                        <div class="swichermainleft">
    ...
    <!-- SHOW PASSWORD JS -->
    <script src="assets/plugins/show-password/show-password.min.js"></script>
